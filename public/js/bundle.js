        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              (0, _notify.showAlert)('success', 'You have loggin successfully');
          ...
          case 7:
            ...
            (0, _notify.showAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _notify.showAlert)('error', _context2.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./notify":"notify.js"}],"animation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.smoothScroll = exports.showPassword = void 0;

var showPassword = function showPassword(inputPassword, iconshow, iconclose) {
  var btnOpen = document.querySelector(".form--login ".concat(iconshow));
  var input = document.querySelector(".form--login ".concat(inputPassword));
  var btnClose = document.querySelector(".form--login ".concat(iconclose));
...
var smoothScroll = function smoothScroll(x, duration) {
  var target = document.querySelector(x);
  var targetPosition = target.getBoundingClientRect().top; // console.log(targetPosition);
...
var fetchData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, data, method, control, handle) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function fetchData(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.paginationShow = exports.loadGallery = void 0;
...
var sumViewCart = document.querySelector('.view-cart span');
var local = JSON.parse(localStorage.getItem('cards')) || [];

var loadGallery = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            type = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'bugger';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              url: "/api/foods?type=".concat(type),
              method: 'GET'
            });
          ...
          case 4:
            ...
            if (res.data.status == 'success') {
              list = _toConsumableArray(res.data.data.data);
...
var paginationShow = function paginationShow(data, elNum) {
  var table = document.querySelector('.recommend_container .recommend_box');
  var num = Math.ceil(data.length / elNum);
  var pagination = document.querySelector('.recommend_container .pagination');
  var pagi_item = document.querySelectorAll('.recommend_container .pagination--item');
  var box_item = table.querySelectorAll('.recommend_container .recommend_box .recommend_box-item');

  if (pagi_item) {
    for (var i = 0; i < pagi_item.length; i++) {
      pagi_item[i].remove();
    }

    for (var g = 0; g < box_item.length; g++) {
      box_item[g].remove();
    }
  }

  var showTable = function showTable(food) {
    return "\n        <div class=\"recommend_box-item\" data-item='".concat(JSON.stringify(food), "'>\n            <div class=\"recommend_box-item_header\">\n                <img src='./images/foods/").concat(food.images[0], "' alt=\"\" />\n                <button><i class=\"fa-solid fa-cart-plus\"></i>Add To Cart</button>\n            </div>\n            <div class=\"recommend_box-item_content\">\n                <div>\n                    <h3>").concat(food.name, "</h3>\n                    <label>$").concat(food.price, "</label>\n                </div>\n                <p>").concat(food.description, "</p>\n            </div>\n        </div>\n        ");
  };

  var _loop = function _loop(_i) {
    var item = document.createElement('li');
    item.setAttribute('class', 'pagination--item');
    item.textContent = _i + 1;
    item.addEventListener('click', function (e) {
      var li = document.querySelectorAll('.recommend_container .recommend_box-item');
      var pagi = document.querySelectorAll('.recommend_container .pagination li');
      ...
      var content = data.slice(_i * elNum, (_i + 1) * elNum).map(function (el) {
        return showTable(el);
      }).join('');
      table.insertAdjacentHTML('beforeend', content);
      var recommendBottons = document.querySelectorAll('.recommend_box-item button');
      recommendBottons.forEach(function (el) {
        var value = JSON.parse(el.closest('.recommend_box-item').dataset.item);
        var icon = el.querySelector('i');
        var ordered = local.findIndex(function (el) {
    ...
    if (_i == 0) {
      item.classList.add('active');
      var content = data.slice(_i, elNum).map(function (el) {
        return showTable(el);
      }).join('');
      table.insertAdjacentHTML('beforeend', content);
      var recommendBottons = document.querySelectorAll('.recommend_box-item button');
...
exports.paginationShow = paginationShow;
},{"axios":"../../node_modules/axios/index.js","./notify":"notify.js"}],"stripe.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.bookCart = void 0;
...
var stripe = Stripe('pk_test_51LPRMzJd69UbnP03qwhwOY0Bnf7mauj1Ifu8VR2XZqBiwVB2dLJtPlWTJxiuRiDmuSPAtB3YVw4si77rWABwnJmQ00FAIa5aiT');

var bookCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(carts, discount, shipping) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function bookCart(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookCart = bookCart;
...
var store_gallerys = document.querySelectorAll('.recommend__gellery li');
var formComment = document.querySelector('.blog_detail_form');
var sumViewCart = document.querySelector('.view-cart span');
var local = JSON.parse(localStorage.getItem('cards')) || [];
var viewCart = document.querySelector('.cart');
var cartFinal = document.querySelector('.cart_final');
...
if (bookNow) {
  bookNow.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _animation.smoothScroll)('.recommend', 2000);
  });
}
...
if (formComment) {
  ...
  document.querySelectorAll('.comment_box a').forEach(function (el) {
    el.addEventListener('click', function (e) {
      to = e.target.dataset.replies;
      var name = e.target.closest('.comment_box').querySelector('h4').textContent;
      comment.focus();
      comment.value = "@".concat(name, " ");
    });
  });
  formComment.addEventListener('submit', function (e) {
    e.preventDefault();
    var post = formComment.dataset.post;
    var data = {
      comment: comment.value,
      to: to
    };
    (0, _fetch.fetchData)("/api/posts/".concat(post, "/comments"), data, "POST", function () {
      location.reload();
    });
  });
}
...
if (store_gallerys) {
  (0, _store.loadGallery)();
  var span = document.querySelector('.represent');
  ...
  store_gallerys.forEach(function (item) {
    item.addEventListener('click', function (e) {
      for (var i = 0; i < store_gallerys.length; i++) {
...
if (alert) {
  console.log(alert);
  (0, _notify.showAlert)('success', alert, 7000);
}

var orderButtons = document.querySelectorAll('.recommend_box-item_header button');
...
var updateCart = function updateCart() {
  local.forEach(function (el) {
    ...
    var tr = "\n        <tr data-item='".concat(JSON.stringify(el), "'>\n            <td>\n                <a class=\"remove-item\"><i class=\"fa-solid fa-trash-can\"></i></a>    \n            </td>\n            <td class=\"table-image\">\n                <img src=\"/images/foods/").concat(el.images[0], "\" />\n            </td>\n            <td class=\"control-mobile\">\n                <a href=\"\" class=\"item-name\">").concat(el.name, "</a>\n                $<span class=\"price\">").concat(el.price, "</span>\n                <div>\n                    <button class=\"decrease\">-</button>\n                    <input class=\"quantity-number\" value=\"").concat(el.number, "\" type=\"text\"/>\n                    <button class=\"increase\">+</button>\n                </div>\n            </td>\n            <td>\n                <a href=\"\" class=\"item-name\">").concat(el.name, "</a>\n            </td>\n            <td>\n                $<span class=\"price\">").concat(el.price, "</span>\n            </td>\n            <td>\n                <button class=\"decrease\">-</button>\n                <input class=\"quantity-number\" value=\"").concat(el.number, "\" type=\"text\"/>\n                <button class=\"increase\">+</button>\n            </td>\n            <td>\n                $<span class=\"price-total\">").concat(el.number ? (el.number * el.price).toFixed(2) : el.price, "</span>\n            </td>\n        </tr>\n        ");
...
if (viewCart) {
  var updateTotal = function updateTotal() {
    var total = local.reduce(function (pre, cur) {
  ...
  var discountFinal = document.querySelector('.cart_final-discount');
  var final = document.querySelector('.cart_final-final');
  var applyCoupon = document.querySelector('.apply_btn');
  updateCart();
  ;
  updateTotal();
  viewCart.querySelectorAll('.remove-item').forEach(function (el) {
    el.addEventListener('click', function (e) {
  ...
  viewCart.querySelector('.cart-update').addEventListener('click', function (e) {
    ...
    try {
      local = [];
      viewCart.querySelectorAll('.cart_list tr').forEach(function (el, index) {
        if (index != 0) {
      ...
      sumViewCart.textContent = local.length;
      localStorage.setItem('cards', JSON.stringify(local));
      var markup = "<div class='alert alert--success'>Updated Cart Successfully</div>";
      document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
      window.setTimeout(hideAlert, 2000);
    } catch (err) {
      var _markup = "<div class='alert alert--error'>Something Was Wrong When Updating Cart</div>";
  ...
  viewCart.querySelector('.btn-checkout').addEventListener('click', function (e) {
    if (local.length != 0) {
      (0, _stripe.bookCart)(local, discountFinal.dataset.coupon || null, {});
    }
  });

  if (applyCoupon) {
    applyCoupon.addEventListener('click', function (e) {
      var inputCode = applyCoupon.closest('.cart_coupon').querySelector('input');
      (0, _fetch.fetchData)("/api/coupons/applyCoupon/".concat(inputCode.value), '', 'GET', function (res) {
        (0, _notify.showAlert)("success", "Apply Coupon Success");
        var coupon = res.data.data.data;
        discountFinal.textContent = coupon.discount.toFixed(2);
        discountFinal.dataset.coupon = coupon.code;
        updateTotal();
      }, function (error) {
        (0, _notify.showAlert)('error', error.response.data.message);
...
if (mePage) {
  var changeAvatarBtn = document.querySelector('#changeAva');
  var applyChangeBtn = document.querySelector('.btn-change');
  applyChangeBtn.addEventListener('click', function (e) {
    var _this = this;

    var form = new FormData();
    var name = document.querySelector('#firstname').value + ' ' + document.querySelector('#lastname').value;
    ...
    (0, _fetch.fetchData)('/api/users/updateMe', form, 'POST', function (res) {
      _this.previousSibling.classList.add('me_status--success');

      if (document.querySelector('#pushNotifi').checked) {
        (0, _notify.showAlert)('success', res.data.message);
      }
      ...
      (0, _notify.showAlert)('error', err.response.data.message);
    });
  });
...
},{"./login":"login.js","./animation":"animation.js","./fetch":"fetch.js","./store":"store.js","./stripe":"stripe.js","./notify":"notify.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
